...
def main() -> int:
    ...
    for rel in (
        ...
        "figures/draft/fig_r05_topology_null.svg",
        "figures/draft/fig_r05_mitigation_tradeoff.svg",
        ...
        "figures/draft/fig_r06_shift_gap.svg",
        "figures/draft/fig_r06_proxy_degradation.svg",
    ):
