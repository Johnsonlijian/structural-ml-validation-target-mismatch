...
def make_main_figure(data: pd.DataFrame) -> None:
    ...
    fig.savefig(OUT_FIG / "fig02_case_study_matrix_v1.png", dpi=300)
    fig.savefig(OUT_FIG / "fig02_case_study_matrix_v1.pdf")
    plt.close(fig)
...
def make_supplementary_stub_figure(stub: pd.DataFrame) -> None:
    ...
    fig, axes = plt.subplots(1, 2, figsize=(9.2, 3.9), gridspec_kw={"width_ratios": [1.3, 1.0]})
