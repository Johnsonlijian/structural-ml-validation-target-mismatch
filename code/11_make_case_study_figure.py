...
Outputs:
    figures/draft/fig02_case_study_matrix_v0.png
    figures/draft/fig02_case_study_matrix_v0.pdf
...
def main() -> None:
    ...
    fig.suptitle(
        "Figure 2 v0. Random validation optimism is heterogeneous across civil-engineering ML datasets",
        fontsize=12,
        fontweight="bold",
        y=0.99,
    )
